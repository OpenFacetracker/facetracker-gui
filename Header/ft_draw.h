...
#define FT_LOGO 		"img/logo.png"
#define FT_YEL_BORDER 	"img/yellow.png"
#define FT_WH_BORDER	"img/white.png"
#define FT_GR_BORDER	"img/green.png"
#define FT_BACK 		"img/ft_background.jpg"
#define FT_NO_SIG		"img/nosig.png"
...
namespace cu{
	class Draw{
		public:
            ...
            IplImage * drawBorder(IplImage *img, const char * path, double x, double y, double width, double height);
