...
namespace ft{
    ...
    class Camera{
        public:
            CvCapture *ftcapture;
            IplImage *ftimg;
            CvHaarClassifierCascade * ftcascade;
            CvMemStorage *ftstorage;
            ...
            CvCapture * ViolaJones(CvHaarClassifierCascade * cascade, CvMemStorage *storage, char KeyStop, char * stream);
