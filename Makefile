...
help:
	...
	@echo  '**************************************'
	@echo
	@echo  'make ftall		: Build facetracker'
...
mcmsg:
	#compile a module
	g++ -c 	-DFT_USE_COLOR=TRUE -DFT_DEBUG_ENABLED=1 -DFT_FORM=1 -DFT_TEST_RECOGNISE=1 Camera/ft_detect.cpp `pkg-config --cflags --libs opencv` -o obj/ftdetect.o
	g++ -c 	-DFT_USE_COLOR=TRUE -DFT_DEBUG_ENABLED=1 -DFT_FORM=1 -DFT_TEST_RECOGNISE=1 Camera/ft_draw.cpp `pkg-config --cflags --libs opencv` -o obj/ftdraw.o
	g++ -c  -DFT_USE_COLOR=TRUE -DFT_DEBUG_ENABLED=1 Utils/ft_utils.cpp -o obj/ftutils.o
	@echo "compiling ft recognition module .."
	make -C Camera/recognition/
